...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body id="<?php echo $body_id; ?>-page" class="js-disabled <?php echo $time_body_class; ?> <?php echo $weather_body_class; ?> <?php echo ADMIN ? 'admin' : 'not-admin'; ?> <?php echo DEBUG ? 'debug' : 'not-debug'; ?> <?php echo 'lang-' . CURRENT_LANG; ?><?php echo CONTROLLER_ADMIN ? ' controller-admin' : ''; ?>">
