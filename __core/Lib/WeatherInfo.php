<?php
	...
	*/
	...
	function weatherInfo($countryId = "SWXX0031", $unit = "c")
	{
		...
		$doc = new DOMDocument();
		$doc->load("http://weather.yahooapis.com/forecastrss?p=$countryId&u=$unit");
		
		// Get all elements that have this namespace (the yweather-elements)
		$elements = $doc->getElementsByTagNameNS("http://xml.weather.yahoo.com/ns/rss/1.0", "*");
		...
		$lbds = $doc->getElementsByTagName("lastBuildDate");
